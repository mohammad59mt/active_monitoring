...
plot "abilene_1_barchart_real_and_measured_delay_max_len_of_route_all_solved.csv" using 3  title "Measured Delay - 1 Monitoring Host",\
"abilene_2_barchart_real_and_measured_delay_max_len_of_route_all_solved.csv" using 3 title "Measured Delay - 2 Monitoring Host",\
"abilene_3_barchart_real_and_measured_delay_max_len_of_route_all_solved.csv" using 3 title "Measured Delay - 3 Monitoring Host",\
"abilene_4_barchart_real_and_measured_delay_max_len_of_route_all_solved.csv" using 3  title "Measured Delay - 4 Monitoring Host",\

...
def myNetwork():
    ...
    s_11_s_2 = {'delay':'4ms'}
    my_var_name = [ k for k,v in locals().iteritems() if k == "s_11_s_2"][0]
    k1,k2,v = get_key_and_value_for_actual_link_delay(s_11_s_2,my_var_name)
    validDelayMatrix [k1] =v
    validDelayMatrix [k2] =v
    net.addLink(s11, s2, cls=TCLink , **s_11_s_2)


    s_11_s_4 = {'delay':'3ms'}
    my_var_name = [ k for k,v in locals().iteritems() if k == "s_11_s_4"][0]
    k1,k2,v = get_key_and_value_for_actual_link_delay(s_11_s_4,my_var_name)
    validDelayMatrix [k1] =v
    validDelayMatrix [k2] =v
    net.addLink(s11, s4, cls=TCLink , **s_11_s_4)


    s_11_s_7 = {'delay':'6ms'}
    my_var_name = [ k for k,v in locals().iteritems() if k == "s_11_s_7"][0]
    k1,k2,v = get_key_and_value_for_actual_link_delay(s_11_s_7,my_var_name)
    validDelayMatrix [k1] =v
    validDelayMatrix [k2] =v
    net.addLink(s11, s7, cls=TCLink , **s_11_s_7)


    s_1_s_10 = {'delay':'3ms'}
    my_var_name = [ k for k,v in locals().iteritems() if k == "s_1_s_10"][0]
    k1,k2,v = get_key_and_value_for_actual_link_delay(s_1_s_10,my_var_name)
    validDelayMatrix [k1] =v
    validDelayMatrix [k2] =v
    net.addLink(s1, s10, cls=TCLink , **s_1_s_10)


    s_1_s_6 = {'delay':'9ms'}
    my_var_name = [ k for k,v in locals().iteritems() if k == "s_1_s_6"][0]
    k1,k2,v = get_key_and_value_for_actual_link_delay(s_1_s_6,my_var_name)
    validDelayMatrix [k1] =v
    validDelayMatrix [k2] =v
    net.addLink(s1, s6, cls=TCLink , **s_1_s_6)


    s_3_s_8 = {'delay':'9ms'}
    my_var_name = [ k for k,v in locals().iteritems() if k == "s_3_s_8"][0]
    k1,k2,v = get_key_and_value_for_actual_link_delay(s_3_s_8,my_var_name)
    validDelayMatrix [k1] =v
    validDelayMatrix [k2] =v
    net.addLink(s3, s8, cls=TCLink , **s_3_s_8)


    s_3_s_4 = {'delay':'9ms'}
    my_var_name = [ k for k,v in locals().iteritems() if k == "s_3_s_4"][0]
    k1,k2,v = get_key_and_value_for_actual_link_delay(s_3_s_4,my_var_name)
    validDelayMatrix [k1] =v
    validDelayMatrix [k2] =v
    net.addLink(s3, s4, cls=TCLink , **s_3_s_4)


    s_4_s_5 = {'delay':'8ms'}
    my_var_name = [ k for k,v in locals().iteritems() if k == "s_4_s_5"][0]
    k1,k2,v = get_key_and_value_for_actual_link_delay(s_4_s_5,my_var_name)
    validDelayMatrix [k1] =v
    validDelayMatrix [k2] =v
    net.addLink(s4, s5, cls=TCLink , **s_4_s_5)


    s_4_s_8 = {'delay':'5ms'}
    my_var_name = [ k for k,v in locals().iteritems() if k == "s_4_s_8"][0]
    k1,k2,v = get_key_and_value_for_actual_link_delay(s_4_s_8,my_var_name)
    validDelayMatrix [k1] =v
    validDelayMatrix [k2] =v
    net.addLink(s4, s8, cls=TCLink , **s_4_s_8)


    s_4_s_9 = {'delay':'3ms'}
    my_var_name = [ k for k,v in locals().iteritems() if k == "s_4_s_9"][0]
    k1,k2,v = get_key_and_value_for_actual_link_delay(s_4_s_9,my_var_name)
    validDelayMatrix [k1] =v
    validDelayMatrix [k2] =v
    net.addLink(s4, s9, cls=TCLink , **s_4_s_9)


    s_4_s_10 = {'delay':'9ms'}
    my_var_name = [ k for k,v in locals().iteritems() if k == "s_4_s_10"][0]
    k1,k2,v = get_key_and_value_for_actual_link_delay(s_4_s_10,my_var_name)
    validDelayMatrix [k1] =v
    validDelayMatrix [k2] =v
    net.addLink(s4, s10, cls=TCLink , **s_4_s_10)


    s_5_s_6 = {'delay':'2ms'}
    my_var_name = [ k for k,v in locals().iteritems() if k == "s_5_s_6"][0]
    k1,k2,v = get_key_and_value_for_actual_link_delay(s_5_s_6,my_var_name)
    validDelayMatrix [k1] =v
    validDelayMatrix [k2] =v
    net.addLink(s5, s6, cls=TCLink , **s_5_s_6)
    ...
    s_6_s_7 = {'delay':'8ms'}
    my_var_name = [ k for k,v in locals().iteritems() if k == "s_6_s_7"][0]
    k1,k2,v = get_key_and_value_for_actual_link_delay(s_6_s_7,my_var_name)
    validDelayMatrix [k1] =v
    validDelayMatrix [k2] =v
    net.addLink(s6, s7, cls=TCLink , **s_6_s_7)


    s_6_s_8 = {'delay':'2ms'}
    my_var_name = [ k for k,v in locals().iteritems() if k == "s_6_s_8"][0]
    k1,k2,v = get_key_and_value_for_actual_link_delay(s_6_s_8,my_var_name)
    validDelayMatrix [k1] =v
    validDelayMatrix [k2] =v
    net.addLink(s6, s8, cls=TCLink , **s_6_s_8)


    s_8_s_9 = {'delay':'9ms'}
    my_var_name = [ k for k,v in locals().iteritems() if k == "s_8_s_9"][0]
    k1,k2,v = get_key_and_value_for_actual_link_delay(s_8_s_9,my_var_name)
    validDelayMatrix [k1] =v
    validDelayMatrix [k2] =v
    net.addLink(s8, s9, cls=TCLink , **s_8_s_9)


    s_9_s_10 = {'delay':'6ms'}
    my_var_name = [ k for k,v in locals().iteritems() if k == "s_9_s_10"][0]
    k1,k2,v = get_key_and_value_for_actual_link_delay(s_9_s_10,my_var_name)
    validDelayMatrix [k1] =v
    validDelayMatrix [k2] =v
    net.addLink(s9, s10, cls=TCLink , **s_9_s_10)
...
#    coordinator_host.popen('python3 ../../coordinator/coordinator.py')

...
class Probes:
    ...
    def main(topo, length_of_probes_array, debug=True):
        ...
        if debug:
            ...
            print('Number of probes: ',number_of_probes)
            print('Number of existing links: ', number_of_existing_links)
            print('Number of included links: ', number_of_included_links)

        if len(probes.switch_switch_set) > len(probes.used_links_set) and debug: print("********ERROR: Some links will not be measured.********\nChange the length_of_probes_array to solve the problem.")
        if len(probes.linkBasedPath_arrayOfList) != len(probes.used_links_set) and debug: print("********WARNING: Number of probes is not the same as Number of links.********\nChange the length_of_probes_array to make them equal.\nAt least keep the number of probes more than the number of links")
...
# heuristic_for_ILP(topo=abilene_topo, length_of_probes_array=abilene_length_of_probes_array, debug=False)

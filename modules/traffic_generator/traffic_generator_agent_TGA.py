...
def post_companies():
    ...
    """traffic_matrix sample = {"dst_ip":"127.0.0.1","ip_tos":"1","ip_protocol":"icmp","flow_label":1}"""
...
#      res = _run_hping3 (str(ip_tos),count,interval,dst_ip)
      res = _run_hping3 (str(int(str(ip_tos),16)),count,interval,dst_ip)
#      print ("res: ",res)
      #hping_result.append(res)
#      print ("aftereeeeeeeeeeeeeeeeeeeee")
      rtt_matrix = _calc_rtt (res)
      #print ("rtt_matrix: ",rtt_matrix)
      min_rtt ,average_rtt, max_rtt = _calc_rtt_stats(rtt_matrix)
      rtt_stats = {"match":{"dst_ip":dst_ip,"ip_tos":ip_tos,"ip_protocol":ip_protocol},"min":min_rtt,"average":average_rtt,"max":max_rtt,"detailed_rtt":rtt_matrix,"flow_label":flow_label}
